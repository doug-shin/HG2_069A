...
#define PUT_MBOX_BYTE(mbox, byte_pos, value)        \
    ...
    {                                               \
        if ((byte_pos) == 0)                        \
            (mbox).MDL.byte.BYTE0 = (Uint8)(value); \
        else if ((byte_pos) == 1)                   \
            (mbox).MDL.byte.BYTE1 = (Uint8)(value); \
        else if ((byte_pos) == 2)                   \
            (mbox).MDL.byte.BYTE2 = (Uint8)(value); \
        else if ((byte_pos) == 3)                   \
            (mbox).MDL.byte.BYTE3 = (Uint8)(value); \
        else if ((byte_pos) == 4)                   \
            (mbox).MDH.byte.BYTE4 = (Uint8)(value); \
        else if ((byte_pos) == 5)                   \
            (mbox).MDH.byte.BYTE5 = (Uint8)(value); \
        else if ((byte_pos) == 6)                   \
            (mbox).MDH.byte.BYTE6 = (Uint8)(value); \
        else if ((byte_pos) == 7)                   \
            (mbox).MDH.byte.BYTE7 = (Uint8)(value); \
    } while (0)
